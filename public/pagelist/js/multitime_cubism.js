...
function cubism_Title(d) {
  var index= d;
  var _names=["BA108裂解炉","BA109裂解炉","BA105裂解炉","BA106裂解炉",
    "BA107裂解炉","BA115裂解炉","BA113裂解炉","BA114裂解炉",
    "BA111裂解炉","BA110裂解炉","BA112裂解炉","DA101汽油分馏塔","DA103急冷塔","DA104工艺水汽提塔",
    "FA134排油罐","FA151分焦罐","FA172注硫罐","FB103HGO进料罐","FB203酸油罐"];
  return _names[index];
}
...
cubism_contextPrototype.horizon = function() {
  var context = this,
      ...
      height = buffer.height = 30,//元素高度
      scale = d3.scale.linear().interpolate(d3.interpolateRound),
      metric = cubism_identity,
      extent = null,
      title = cubism_Title,
      format = d3.format(".2s"),
      colors = ["#08519c","#3182bd","#6baed6","#bdd7e7","#6ace69","#fdfa15","#fd9706","#fe0202"];
      //colors = ["#08519c","#3182bd","#6baed6","#bdd7e7","#e8cc97","#67b8d6","#369b9f","#2dcb09"];
