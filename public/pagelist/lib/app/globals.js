...
var angleRange=320,
    ...
    maxMonth=15,
    maxYear=0,
    monthOffset=(monthWidth)/(maxYear*15+maxMonth),
    countries,
    e_labels=[],
    e_chords=[],
    i_labels=[],
    ...
    formatCurrency = function(d) { return formatNumber(d)+"千克标油/吨乙烯"},
    eTextUpdate,
    eChordUpdate,
    TextUpdate,
    iChordUpdate;
...
var monthsMap=["2015/4/15","2015/4/16","2015/4/17","2015/4/18","2015/4/19","2015/4/20","2015/4/21","2015/4/22","2015/4/23","2015/4/24","2015/4/25","2015/4/26","2015/4/27","2015/4/28","2015/4/29"]
...
d3.select(document.getElementById("imgDiv"))
    .style("left","20px").style("top","40px");
