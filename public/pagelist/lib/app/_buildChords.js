...
function buildChords(y,m) {
    ...
    for (var i=0; i < export_chord.groups().length; i++) {
        ...
        var num=i
        if(export_chord.chords()[13]==undefined){
            var sundata=export_chord.chords()[12];
            sundata.source={index: 14, subindex: 14, startAngle: export_chord.groups()[13].startAngle, endAngle: export_chord.groups()[13].startAngle, value: 0}
            //var export_chorddata=export_chord.groups()[14]
            export_chord.chords().push(sundata)
        }
        //if(export_chord.chords(14)==undefined){
        //    var sundata=export_chord.chords()[13];
        //    sundata.source={index: 14, subindex: 14, startAngle: export_chord.groups()[13].startAngle, endAngle: export_chord.groups()[13].startAngle, value: 0}
        //    //var export_chorddata=export_chord.groups()[14]
        //    export_chord.chords().push(sundata)
        //}
